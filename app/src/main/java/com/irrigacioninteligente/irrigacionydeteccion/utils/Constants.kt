...
object Constants {
    ...
    const val PURPLE_LIGHT = 0xFFE8D5FF
    const val GREEN_PLANT = 0xFF4CAF50
    const val PINK_ACCENT = 0xFFEC407A
    const val GRAY_BUTTON = 0xFF757575

    // Textos de la aplicación
    const val APP_TITLE = "IRRIGACION INTELIGENTE"
